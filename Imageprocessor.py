...
def imgprcwithpath(image_path, folder_name):
    ...
    img = Image.open(image_path + ".jpg", 'r')         #.convert('L')
    ...
    #img.save("{}/{}/{}.jpg".format(foldername, folder_name, Path(image_path).stem))
    ...
    for x in range(N+1):
        ...
        #img2.save("{}/{}/{}/{}_Filtered{}.jpg".format(os.getcwd(), foldername, folder_name, Path(image_path).stem, x))

    img2 = Image.fromarray(np.array(D, dtype=np.uint8))

    img2.save("{}/{}/{}/{}_DMP.jpg".format(os.getcwd(), foldername, folder_name, Path(image_path).stem))
...
def imgprc(single_image, folder_name):
    ...
    image = Image.open(single_image + ".jpg", 'r')         #.convert('L')
    ...
    #img.save("{}/{}/{}.jpg".format(foldername, folder_name, folder_name))
    ...
    for x in range(8):   #N+1
        ...
        #img2.save("{}/{}/{}/{}_Filtered{}.jpg".format(os.getcwd(), foldername, folder_name, folder_name, x))

    img2 = Image.fromarray(np.array(D, dtype=np.uint8))

    #img2.save("{}/{}/{}/{}_DMP.jpg".format(os.getcwd(), foldername, folder_name, folder_name))
